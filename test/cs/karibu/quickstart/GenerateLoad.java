...
public class GenerateLoad {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    if (args.length != 2) {
      ...
      System.out
          .println("     resource-root-folder = root folder which contains the exchange.properties file");
    ...
    readingHandler =
        new StandardClientRequestHandler<ExampleMeasurement>(
            DomainConstants.PRODUCER_CODE_EXAMPLE_MEASUREMENT, connector, serializer);

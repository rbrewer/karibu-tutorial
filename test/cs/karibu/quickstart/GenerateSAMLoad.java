...
import cs.karibu.exampledomain.DomainConstants;
...
import dk.au.cs.karibu.producer.rabbitmq.StandardRabbitExchangeConfiguration;
...
public class GenerateSAMLoad {
  ...
  public static void main(String[] args) throws IOException, InterruptedException { 
    ...
    ClientRequestHandler<SAMReadingV001> readingHandler;
    Serializer<SAMReadingV001> serializer;
    serializer = new SAMRE001Serializer();

    readingHandler = new StandardClientRequestHandler<SAMReadingV001>("SAMRE001",  
